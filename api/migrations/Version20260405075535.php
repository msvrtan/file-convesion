...
final class Version20260405075535 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE conversion (id CHAR(36) NOT NULL, owner_id CHAR(36) NOT NULL, source_format VARCHAR(32) NOT NULL, target_format VARCHAR(32) NOT NULL, status SMALLINT NOT NULL, message CLOB DEFAULT NULL, created_at DATETIME NOT NULL, processing_started_at DATETIME DEFAULT NULL, processing_ended_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
